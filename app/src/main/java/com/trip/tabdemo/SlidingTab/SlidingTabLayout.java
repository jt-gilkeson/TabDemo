 ...
 */
package com.trip.tabdemo.SlidingTab;
...
public class SlidingTabLayout extends HorizontalScrollView
{
	...
	private ColorStateList mTextSelector;
	...
	public void setTextSelector(ColorStateList textSelector)
	{
	...
	private void populateTabStrip() {
		...
		for (int i = 0; i < adapter.getCount(); i++) {
			...
			if (mTextSelector != null)
			{
				tabTitleView.setTextColor(mTextSelector);
			}
